      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            Connectez-vous instantanément avec des prestataires événementiels de qualité.
            DJ, traiteurs, photographes, décorateurs... Organisez l'événement dont vous rêvez en toute simplicité.
          </p>
