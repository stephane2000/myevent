      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-stone-500">Deux façons d'utiliser PrestaBase</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="text-center p-8 rounded-2xl bg-stone-100/50">
              ...
              <h3 className="text-lg font-semibold text-stone-900 mb-2">Vous organisez un événement ?</h3>
              <p className="text-stone-500 text-sm">Publiez votre annonce → Recevez des propositions → Choisissez votre prestataire</p>
            </div>
            ...
            <div className="text-center p-8 rounded-2xl bg-stone-100/50">
              ...
              <h3 className="text-lg font-semibold text-stone-900 mb-2">Vous êtes prestataire ?</h3>
              <p className="text-stone-500 text-sm">Créez votre profil → Consultez les annonces → Proposez vos services</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-stone-100 py-12 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-10">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-semibold text-stone-900">PrestaBase</span>
              </div>
          ...
          <div className="pt-8 border-t border-stone-100 flex flex-col md:flex-row items-center justify-between gap-4">
            <span className="text-sm text-stone-400">© 2026 PrestaBase. Tous droits réservés.</span>
