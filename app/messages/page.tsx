        ...
        <div className="bg-white border border-orange-100 rounded-2xl p-8 shadow-xl">
          ...
          <div className="border-t border-orange-100 pt-8">
            <p className="text-gray-700 mb-6">
              Votre messagerie est en cours de développement. Bientôt vous pourrez :
            </p>
            ...
            <div className="grid gap-4">
              <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border border-orange-100">
                ...
                <span className="text-gray-700">Échanger avec les prestataires</span>
              </div>
              <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border border-orange-100">
                <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                <span className="text-gray-700">Recevoir des devis</span>
              </div>
              <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border border-orange-100">
                <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                <span className="text-gray-700">Suivre vos conversations</span>
              </div>
            </div>
          </div>
        </div>
