...
export default function Parametres() {
  ...
  async function handleSaveNotifications() {
    ...
    try {
      ...
      await supabase.rpc('log_user_activity', {
        p_action_type: 'profile_updated',
        p_action_description: 'Préférences de notification mises à jour',
        p_metadata: { emailNotifications, smsNotifications, marketingEmails }
      })
  ...
  async function handleSavePrivacy() {
    ...
    try {
      ...
      await supabase.rpc('log_user_activity', {
        p_action_type: 'profile_updated',
        p_action_description: 'Paramètres de confidentialité mis à jour',
        p_metadata: { profileVisibility, showEmail, showPhone }
      })
